...
public class ThreadTask {
    ...
    public void cancel(Runnable r) {
        if (netThreadPool != null) {
            // 从线程队列中移除对象
            netThreadPool.getQueue().remove(r);
        }
        if (dbThreadPool != null) {
            // 从线程队列中移除对象
            dbThreadPool.getQueue().remove(r);
        }
        if (otherThreadPool != null) {
            // 从线程队列中移除对象
            otherThreadPool.getQueue().remove(r);
        }
    }
